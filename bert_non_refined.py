...
amostra = data#.sample(frac=0.5, random_state=123) 
#print(amostra)
####### BANCO DE DADOS #######
...
embeddings = sentence.encode(amostra['produtos'].tolist(), show_progress_bar=False)
...
topicos, probabilidades = modelo.fit_transform(amostra['produtos'], embeddings)
...
amostra.to_csv('D:/Antonio/Documentos/ArquivosUFRGS/8semestre/tcc/a_imagens/config_geral/amostra_50pc.csv', index = False)
...
fig.write_html("D:/Antonio/Documentos/ArquivosUFRGS/8semestre/tcc/a_imagens/config_geral/foto1.html")
fig2.write_html("D:/Antonio/Documentos/ArquivosUFRGS/8semestre/tcc/a_imagens/config_geral/foto2.html")
fig3.write_html("D:/Antonio/Documentos/ArquivosUFRGS/8semestre/tcc/a_imagens/config_geral/foto3.html")
